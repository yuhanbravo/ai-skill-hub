...
> Type: protocol guide, not a skill
>
> Use this document to understand how AI tools discover skills and jump from adapter entrypoints to canonical definitions and invocation docs.
>
> Do not treat this file as a callable skill or a skill-writing template.

## Scope

- Owns: how AI tools discover skills in this repository, how discovery entrypoints jump to canonical skill definitions, and where invocation docs live
- Does not own: execution-section authoring rules inside `SKILL.md`, or repository-level human consumption guidance
- See also:
