...
- Freshness gate: previous `Updated at` was `2026-05-26`, which is within the `14`-day freshness gate on `2026-06-02`; this refresh updates the status date to `2026-06-02`, so no `Staleness` risk is added.
