...
- Project-level post-dev dual-refresh prompt: [prompts/post_dev_dual_refresh_project_prompt.md](prompts/post_dev_dual_refresh_project_prompt.md)
- GitHub PR bootstrap prompt: [prompts/github_pr_bootstrap_prompt.md](prompts/github_pr_bootstrap_prompt.md)
